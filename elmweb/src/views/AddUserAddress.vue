...
const addUserAddress = () => {
  ...
  deliveryAddress.value.userId = user.userId;
  console.log(deliveryAddress);

  let addDeliveryAddressUrl = `DeliveryAddressController/saveDeliveryAddress/${deliveryAddress.value.contactName}/${deliveryAddress.value.contactSex}/${deliveryAddress.value.contactTel}/${deliveryAddress.value.address}/${deliveryAddress.value.userId}`
  axios
    .post(addDeliveryAddressUrl)
    .then((response) => {
